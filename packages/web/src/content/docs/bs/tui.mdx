---
title: TUI
description: Korištenje korisničkog interfejsa Cipher terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Cipher pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje Cipher pokreće TUI za trenutni direktorij.
...
Kada koristite Cipher TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u Cipher. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz Cipher. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `cipher.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
- `leader_timeout` - Kontroliše koliko dugo Cipher čeka nakon leader key. Podrazumijevano je `2000`.
...
- `sound_pack` - Sound pack ID koji se koristi. Podrazumijevano je `Cipher.default`.
