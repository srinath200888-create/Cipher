...
import { Slug } from "@cipher-ai/core/util/slug"
...
import type { ProviderMetadata, Usage } from "@cipher-ai/llm"
...
import { locationServiceMapLayer } from "@cipher-ai/core/location-services"
...
import { PartTable, SessionTable } from "@cipher-ai/core/session/sql"
...
import { WorkspaceV2 } from "@cipher-ai/core/workspace"
import { SessionID, MessageID, PartID } from "./schema"

import type { Provider } from "@/provider/provider"
import { Global } from "@cipher-ai/core/global"
import { Effect, Layer, Option, Context, Schema, Types } from "effect"
import { NonNegativeInt, optional } from "@cipher-ai/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".cipher", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@cipher/Session") {}
