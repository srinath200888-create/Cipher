---
title: Zen
description: Udvalgt liste over modeller leveret af Cipher.
---
...
Cipher Zen er en liste over testede og verificerede modeller leveret af cipher-teamet.

Zen fungerer som enhver anden udbyder i Cipher. Du logger ind på Cipher Zen og får
...
:::tip
Vi testede en udvalgt gruppe modeller og udbydere, som fungerer godt med Cipher.
:::
...
Cipher Zen er en AI gateway, der giver dig adgang til disse modeller.

---

## Sådan fungerer det

Cipher Zen fungerer som enhver anden udbyder i Cipher.

1. Du logger ind på **<a href={console}>Cipher Zen</a>**, tilføjer dine faktureringsoplysninger
   og kopierer din API-nøgle.
2. Du kører kommandoen `/connect` i TUI, vælger Cipher Zen og indsætter din API-nøgle.
...
[model id](/docs/config/#models) i din cipher-konfiguration
bruger formatet `opencode/<model-id>`. For eksempel ville du for GPT 5.5
bruge `cipher/gpt-5.5` i din konfiguration.
...
- DeepSeek V4 Flash Free er tilgængelig på Cipher i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- MiMo-V2.5 Free er tilgængelig på Cipher i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- North Mini Code Free er tilgængelig på Cipher i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Nemotron 3 Ultra Free er tilgængelig på Cipher i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Big Pickle er en stealth-model, som er gratis på Cipher i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
...
4. Have **ingen lock-in** ved at lade dig bruge det med enhver anden kodeagent. Og altid lade dig bruge enhver anden udbyder med Cipher også.
