...
Utwórz `.cipher/commands/test.md`:
...
Możesz zdefiniować polecenia w `cipher.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji Cipher:
...
Cipher zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
