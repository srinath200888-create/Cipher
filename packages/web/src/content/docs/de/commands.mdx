...
Erstellen Sie `.cipher/commands/test.md`:

```md title=".cipher/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die cipher-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem Cipher [config](/docs/config):

```json title="cipher.jsonc" {4-12}
{
...
```md title=".cipher/commands/component.md"
---
...
```md title=".cipher/commands/create-file.md"
---
...
```md title=".cipher/commands/analyze-coverage.md"
---
...
```md title=".cipher/commands/review-changes.md"
---
...
```md title=".cipher/commands/review-component.md"
---
...
Cipher enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
