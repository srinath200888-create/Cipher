...
Agentferdigheter lar Cipher oppdage gjenbrugbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går Cipher opp fra din nåværende arbejdskatalog til den når git-arbeidstreet.
...
Cipher viser tilgængelige ferdigheter i `skill` verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved at bruge mønsterbaserte tillatelser i `cipher.json`:
