---
title: Zen
description: Lista seleccionada de modelos proporcionada por Cipher.
---
...
Cipher Zen es una lista de modelos probados y verificados proporcionada por el equipo de Cipher.

Zen funciona como cualquier otro proveedor en Cipher. Inicias sesión en Cipher Zen y obtienes
...
:::tip
Probamos un grupo selecto de modelos y proveedores que funcionan bien con Cipher.
:::
...
Cipher Zen es un gateway de AI que te da acceso a estos modelos.

---

## Cómo funciona

Cipher Zen funciona como cualquier otro proveedor en Cipher.

1. Inicias sesión en **<a href={console}>Cipher Zen</a>**, agregas tus datos de facturación
   y copias tu API key.
2. Ejecutas el comando `/connect` en la TUI, seleccionas Cipher Zen y pegas tu API key.
...
El [identificador del modelo](/docs/config/#models) en tu configuración de Cipher
usa el formato `opencode/<model-id>`. Por ejemplo, para GPT 5.5, usarías
`cipher/gpt-5.5` en tu configuración.
...
- DeepSeek V4 Flash Free está disponible en Cipher por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- MiMo-V2.5 Free está disponible en Cipher por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- North Mini Code Free está disponible en Cipher por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- Nemotron 3 Ultra Free está disponible en Cipher por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- Big Pickle es un modelo stealth que es gratuito en Cipher por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
...
4. Que no haya **lock-in** al permitirte usarlo con cualquier otro agente de coding. Y permitirte siempre usar también cualquier otro proveedor con Cipher.
