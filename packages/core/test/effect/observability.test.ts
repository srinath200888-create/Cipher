...
const opencodeClient = process.env.CIPHER_CLIENT

afterEach(() => {
  if (otelResourceAttributes === undefined) delete process.env.OTEL_RESOURCE_ATTRIBUTES
  else process.env.OTEL_RESOURCE_ATTRIBUTES = otelResourceAttributes

  if (opencodeClient === undefined) delete process.env.CIPHER_CLIENT
  else process.env.CIPHER_CLIENT = opencodeClient
})
