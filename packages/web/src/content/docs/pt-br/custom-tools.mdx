...
description: Crie ferramentas que o LLM pode chamar no Cipher.
---

Ferramentas personalizadas são funções que você cria e que o LLM pode chamar durante as conversas. Elas funcionam junto com as [ferramentas integradas](/docs/tools) do Cipher, como `read`, `write` e `bash`.
...
- Localmente, colocando-as no diretório `.cipher/tools/` do seu projeto.
