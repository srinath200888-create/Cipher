...
import { FileSystemWatcher } from "@cipher-ai/schema/filesystem-watcher"
...
declare const CIPHER_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof CIPHER_LIBC === "undefined" ? undefined : CIPHER_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@cipher/v2/FileWatcher") {}

const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.CIPHER_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (yield* Flag.CIPHER_EXPERIMENTAL_FILEWATCHER) {
