...
description: Cipher dile özgü biçimlendiriciler kullanır.
---

Cipher, dosyaları dile özgü formatlayıcılar kullanılarak yazıldıktan veya düzenlendikten sonra otomatik olarak formatlar. Bu, oluşturulan kodun projenizin kod stillerine uymasını sağlar.

---

## Yerleşik

Cipher, popüler diller ve çerçeveler için çeşitli yerleşik biçimlendiricilerle birlikte gelir. Aşağıda ihtiyaç duyduğu biçimlendiricilerin, desteklenen dosya uzantılarının ve komutların veya yapılandırma seçeneklerinin bir listesi bulunmaktadır.
...
Yani eğer projenizin `package.json` dosyasında `prettier` varsa, Cipher bunu otomatik olarak kullanacaktır.

---

## Nasıl çalışır?

Cipher bir dosyayı yazdığında veya düzenlediğinde:
...
Biçimlendiricileri Cipher yapılandırmanızdaki `formatter` bölümü aracılığıyla özelleştirebilirsiniz.
