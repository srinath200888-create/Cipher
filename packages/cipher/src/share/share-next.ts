...
import type * as SDK from "@cipher-ai/sdk/v2"
...
import { SessionShareTable } from "@cipher-ai/core/share/sql"
...
const disabled = process.env["CIPHER_DISABLE_SHARE"] === "true" || process.env["CIPHER_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@cipher/ShareNext") {}
