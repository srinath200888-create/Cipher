...
import { EventSequenceTable, EventTable } from "@cipher-ai/core/event/sql"
...
import { WorkspaceEvent } from "@cipher-ai/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@cipher/Workspace") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        CIPHER_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        CIPHER_WORKSPACE_ID: config.id,
        CIPHER_EXPERIMENTAL_WORKSPACES: "true",
