---
title: Paylasim
description: Cipher konusmalarini genel baglantilarla paylasin.
---

cipher'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda Cipher:
...
Cipher, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak Cipher manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `cipher.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda Cipher kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
