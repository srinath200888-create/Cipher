 ...
 *   "@cipher/ServerAuthConfig",
 *   {
 *     password: Config.string("CIPHER_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("CIPHER_SERVER_USERNAME").pipe(Config.withDefault("cipher")),
 *   },
 * ) {}
 *
