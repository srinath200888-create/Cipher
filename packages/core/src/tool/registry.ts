...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@cipher-ai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@cipher/v2/ToolRegistry") {}
