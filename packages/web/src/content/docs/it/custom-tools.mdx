...
description: Crea strumenti che l'LLM puo chiamare in Cipher.
---

Gli strumenti personalizzati sono funzioni che crei e che l'LLM puo chiamare durante le conversazioni. Funzionano insieme agli [strumenti integrati](/docs/tools) di Cipher come `read`, `write` e `bash`.
...
- In locale, mettendoli nella directory `.cipher/tools/` del progetto.
