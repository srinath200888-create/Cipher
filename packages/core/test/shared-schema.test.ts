...
import { ModelV2 } from "@cipher-ai/core/model"
import { SessionV2 } from "@cipher-ai/core/session"
import { Agent } from "@cipher-ai/schema/agent"
import { Location } from "@cipher-ai/schema/location"
import { Model } from "@cipher-ai/schema/model"
import { AgentAttachment, FileAttachment, Prompt, Source } from "@cipher-ai/schema/prompt"
import { Provider } from "@cipher-ai/schema/provider"
import { Project } from "@cipher-ai/schema/project"
import { ProjectDirectories } from "@cipher-ai/schema/project-directories"
import { PermissionV1 } from "@cipher-ai/schema/permission-v1"
import { Session } from "@cipher-ai/schema/session"
import { SessionInput } from "@cipher-ai/schema/session-input"
import { SessionMessage } from "@cipher-ai/schema/session-message"
import { Workspace } from "@cipher-ai/schema/workspace"
import { Command } from "@cipher-ai/schema/command"
import { Connection } from "@cipher-ai/schema/connection"
import { Credential } from "@cipher-ai/schema/credential"
import { FileSystem } from "@cipher-ai/schema/filesystem"
import { Integration } from "@cipher-ai/schema/integration"
import { LLM } from "@cipher-ai/schema/llm"
import { Permission } from "@cipher-ai/schema/permission"
import { Plugin } from "@cipher-ai/schema/plugin"
import { Pty } from "@cipher-ai/schema/pty"
import { Reference } from "@cipher-ai/schema/reference"
import { SessionTodo } from "@cipher-ai/schema/session-todo"
import { Skill } from "@cipher-ai/schema/skill"
import { AbsolutePath, DateTimeUtcFromMillis, optional, statics } from "@cipher-ai/schema/schema"
import { ProviderV2 } from "@cipher-ai/core/provider"
...
test("Core reuses the canonical shared schemas", async () => {
  const [
    ...
    import("@cipher-ai/core/command"),
    import("@cipher-ai/core/integration/connection"),
    import("@cipher-ai/core/credential"),
    import("@cipher-ai/core/filesystem"),
    import("@cipher-ai/core/integration"),
    import("@cipher-ai/core/location"),
    import("@cipher-ai/llm"),
    import("@cipher-ai/core/permission"),
    import("@cipher-ai/core/v1/permission"),
    import("@cipher-ai/core/project/copy"),
    import("@cipher-ai/core/pty"),
    import("@cipher-ai/core/project/schema"),
    import("@cipher-ai/core/reference"),
    import("@cipher-ai/core/session/input"),
    import("@cipher-ai/core/session/message"),
    import("@cipher-ai/core/session/todo"),
    import("@cipher-ai/core/session/prompt"),
    import("@cipher-ai/core/skill"),
    import("@cipher-ai/core/v2-schema"),
    import("@cipher-ai/core/schema"),
    import("@cipher-ai/core/workspace"),
  ])
