...
const releaseId = process.env.CIPHER_RELEASE
if (!releaseId) throw new Error("CIPHER_RELEASE is required")

const version = process.env.CIPHER_VERSION
if (!version) throw new Error("CIPHER_VERSION is required")
