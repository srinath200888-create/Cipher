...
import { normalizePromptContent } from "@cipher-ai/tui/editor"
...
import { CIPHER_BASE_MODE, useBindings } from "@cipher-ai/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close cipher" } satisfies SlashOption,
    ]
