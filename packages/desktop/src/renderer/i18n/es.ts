export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de cipher",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de cipher. ¿Quieres instalarla y reiniciar?",
