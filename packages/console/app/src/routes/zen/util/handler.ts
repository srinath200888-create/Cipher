...
import { and, Database, eq, isNull, lt, or, sql } from "@cipher-ai/console-core/drizzle/index.js"
import { KeyTable } from "@cipher-ai/console-core/schema/key.sql.js"
import { BillingTable, LiteTable, SubscriptionTable, UsageTable } from "@cipher-ai/console-core/schema/billing.sql.js"
import { centsToMicroCents } from "@cipher-ai/console-core/util/price.js"
import { getMonthlyBounds, getWeekBounds } from "@cipher-ai/console-core/util/date.js"
import { Identifier } from "@cipher-ai/console-core/identifier.js"
import { Billing } from "@cipher-ai/console-core/billing.js"
import { Actor } from "@cipher-ai/console-core/actor.js"
import { WorkspaceTable } from "@cipher-ai/console-core/schema/workspace.sql.js"
import { ZenData } from "@cipher-ai/console-core/model.js"
import { Subscription } from "@cipher-ai/console-core/subscription.js"
import { BlackData } from "@cipher-ai/console-core/black.js"
import { UserTable } from "@cipher-ai/console-core/schema/user.sql.js"
import { ModelTable } from "@cipher-ai/console-core/schema/model.sql.js"
import { ProviderTable } from "@cipher-ai/console-core/schema/provider.sql.js"
...
import { LiteData } from "@cipher-ai/console-core/lite.js"
import { Resource } from "@cipher-ai/console-resource"
...
import { Workspace } from "@cipher-ai/console-core/workspace.js"
...
export async function handler(
  ...
  try {
    ...
    const sessionId = input.request.headers.get("x-cipher-session") ?? ""
    const requestId = input.request.headers.get("x-cipher-request") ?? ""
    const ocClient = input.request.headers.get("x-cipher-client") ?? ""
    const projectId = input.request.headers.get("x-cipher-project") ?? ""
    ...
    */
    ...
    const retriableRequest = async (retry: RetryOptions = { excludeProviders: [], retryCount: 0 }) => {
      ...
      const res = await fetchWith429Retry(
        reqUrl,
        {
          ...
          headers: (() => {
            ...
            headers.delete("x-cipher-request")
            headers.delete("x-cipher-session")
            headers.delete("x-cipher-project")
            headers.delete("x-cipher-client")
            return headers
          })(),
          body: reqBody,
      ...
      if (isNewInference) {
        const resEndpointId = res.headers.get("x-cipher-endpoint-id")
        const resEndpointModelId = res.headers.get("x-cipher-upstream-model-id")
