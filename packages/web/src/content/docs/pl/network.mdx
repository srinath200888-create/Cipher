...
Cipher obsługa standardowego zmiennego proxy i certyfikatów dla usług sieciowych przedsiębiorstw.

---

## Pełnomocnik

Cipher respektuje standardowe zmienne środowiskowe proxy.
...
Jeśli Twoje przedsiębiorstwo korzysta z niestandardowych usług, urzędów dostępu do HTTPS, skonfiguruj Cipher tak, aby im ufać.
