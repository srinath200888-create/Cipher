...
export const dict = {
  ...
  "dialog.provider.cipher.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.cipher.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.cipherGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "cipher tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve cipher'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.cipherZen.line1":
    "cipher Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.cipherZen.visit.prefix": "",
  "provider.connect.cipherZen.visit.link": "cipher.ai/zen",
  "provider.connect.cipherZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve cipher'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak cipher'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler cipher.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi cipher sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "cipher'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı cipher ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (cipher.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: cipher henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "cipher ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "cipher Masaüstü",
  ...
  "settings.desktop.wsl.description": "cipher sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "cipher'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "cipher'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "cipher'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "cipher'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "cipher başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "cipher'un en son sürümünü kullanıyorsunuz.",
