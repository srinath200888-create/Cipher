...
Generates UPCOMING_CHANGELOG.md by running the cipher changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for cipher run (default: low)
      --quiet            Suppress cipher command output unless it fails
