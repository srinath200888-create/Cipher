---
title: TUI
description: Brug af cipher-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Cipher giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre Cipher starter TUI for den nuværende mappe.
...
Når du bruger Cipher TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til Cipher. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut Cipher. _Aliaser_: `/quit`, `/q`
...
Dette er adskilt fra `cipher.json`, som konfigurerer server-/kørselstidsadfærd.
...
- `leader_timeout` - Styrer hvor længe Cipher venter efter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID der skal bruges. Standard er `Cipher.default`.
