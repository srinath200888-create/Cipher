...
import defaultSoundPath from "@cipher-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@cipher-ai/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@cipher-ai/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@cipher-ai/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@cipher-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@cipher-ai/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "cipher"
const DEFAULT_PACK_ID = "cipher.default"
