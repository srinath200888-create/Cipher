...
export const dict = {
  ...
  "dialog.provider.cipher.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.cipher.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.cipherGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av cipher",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i cipher.",
  ...
  "provider.connect.cipherZen.line1":
    "cipher Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  "provider.connect.cipherZen.line2":
    "Med én enkelt API-nøkkel får du tilgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.cipherZen.visit.prefix": "Besøk ",
  "provider.connect.cipherZen.visit.link": "cipher.ai/zen",
  "provider.connect.cipherZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i cipher.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i cipher.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i cipher.json",
  ...
  "dialog.server.description": "Bytt hvilken cipher-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av cipher ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til cipher-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (cipher.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at cipher ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "cipher inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør cipher-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for cipher",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan cipher ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om cipher skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan cipher er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når cipher starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av cipher.",
