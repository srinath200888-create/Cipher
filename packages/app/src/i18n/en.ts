export const dict = {
  ...
  "dialog.provider.cipher.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.cipher.tagline": "Reliable optimized models",
  "dialog.provider.cipherGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by cipher",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in cipher.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.cipherZen.line1":
    "cipher Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.cipherZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.cipherZen.visit.prefix": "Visit ",
  "provider.connect.cipherZen.visit.link": "cipher.ai/zen",
  "provider.connect.cipherZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in cipher.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in cipher.",
  ...
  "dialog.plugins.empty": "Plugins configured in cipher.json",
  ...
  "dialog.server.description": "Switch which cipher server this app connects to.",
  ...
  "wsl.onboarding.step.cipher": "cipher",
  ...
  "wsl.onboarding.checkingOpencode": "Checking cipher...",
  "wsl.onboarding.checkingOpencodeIn": "Checking cipher in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating cipher...",
  "wsl.onboarding.updatingOpencodeIn": "Updating cipher in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update cipher in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update cipher",
  "wsl.onboarding.cipherReadyIn": "cipher is ready in {{distro}}.",
  "wsl.onboarding.cipherReady": "cipher is ready.",
  "wsl.onboarding.installOpencodeIn": "Install cipher in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install cipher",
  ...
  "wsl.onboarding.distroStatus.cipherMissing": "cipher not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before cipher can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "cipher could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen cipher.",
  ...
  "toast.update.description": "A new version of cipher ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the cipher team",
  ...
  "error.chain.checkConfig": "Check your config (cipher.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, cipher does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "cipher includes free models so you can start immediately.",
  ...
  "app.name.desktop": "cipher Desktop",
  ...
  "settings.desktop.wsl.description": "Run the cipher server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for cipher",
  ...
  "settings.general.row.appearance.description": "Customise how cipher looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether cipher follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how cipher is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when cipher launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of cipher.",
