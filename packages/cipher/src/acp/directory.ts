...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@cipher/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@cipher/ACPDirectory") {}
