---
title: خوادم LSP
description: يتكامل Cipher مع خوادم LSP لديك.
---

يمكن أن يتكامل Cipher مع خوادم Language Server Protocol (LSP) لاستخدام التشخيصات كملاحظات للوكيل.

---

## المدمجة

يأتي Cipher مع عدة خوادم LSP مدمجة للغات الشائعة:
...
:::note
يمكنك تعطيل تنزيلات خوادم LSP التلقائية عبر ضبط متغير البيئة `CIPHER_DISABLE_LSP_DOWNLOAD` على `true`.
:::
...
عند تفعيل LSP وفتح Cipher لملف، فإنه:
...
يمكنك تفعيل خوادم LSP وتخصيصها عبر قسم `lsp` في إعدادات Cipher.
