export const dict = {
  ...
  "dialog.provider.cipher.note": "Claude, GPT, Gemini 등을 포함한 엄선된 모델",
  "dialog.provider.cipher.tagline": "신뢰할 수 있는 최적화 모델",
  "dialog.provider.cipherGo.tagline": "모두를 위한 저렴한 구독",
  ...
  "provider.connect.cipherZen.line1":
    "cipher Zen은 코딩 에이전트를 위해 최적화된 신뢰할 수 있는 엄선된 모델에 대한 액세스를 제공합니다.",
  "provider.connect.cipherZen.line2": "단일 API 키로 Claude, GPT, Gemini, GLM 등 다양한 모델에 액세스할 수 있습니다.",
  "provider.connect.cipherZen.visit.prefix": "다음 ",
  "provider.connect.cipherZen.visit.link": "cipher.ai/zen",
  "provider.connect.cipherZen.visit.suffix": "을 방문하여 API 키를 받으세요.",
  ...
  "dialog.plugins.empty": "cipher.json에 구성된 플러그인",
  ...
  "dialog.server.description": "이 앱이 연결할 cipher 서버를 전환합니다.",
  ...
  "error.page.report.prefix": "이 오류를 cipher 팀에 제보해 주세요: ",
  ...
  "error.chain.checkConfig": "구성(cipher.json)의 공급자/모델 이름을 확인하세요",
  ...
  "settings.desktop.wsl.description": "Windows의 WSL 내부에서 cipher 서버를 실행합니다.",
  ...
  "settings.general.row.language.description": "cipher 표시 언어 변경",
  ...
  "settings.general.row.theme.description": "cipher 테마 사용자 지정",
