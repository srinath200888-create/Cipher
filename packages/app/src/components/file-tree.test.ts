...
beforeAll(async () => {
  ...
  mock.module("@cipher-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@cipher-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@cipher-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@cipher-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
