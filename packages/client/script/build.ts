...
import { compile, emitEffectImported, emitPromise, write } from "@cipher-ai/httpapi-codegen"
        ...
        emitPromise(contract, {
          outputTypes: {
            "events.subscribe": {
              ...
              import: 'import type { OpenCodeEventEncoded } from "@cipher-ai/protocol/groups/event"',
            },
          },
        }),
