...
export const dict = {
  ...
  "notFound.title": "페이지를 찾을 수 없음 | cipher",
  "notFound.heading": "404 - 페이지를 찾을 수 없음",
  "notFound.home": "홈",
  "notFound.docs": "문서",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "cipher 밝은 로고",
  "notFound.logoDarkAlt": "cipher 어두운 로고",
  ...
  "app.meta.description": "cipher - 오픈 소스 코딩 에이전트.",

  "home.title": "cipher | 오픈 소스 AI 코딩 에이전트",

  "temp.title": "cipher | 터미널을 위해 만들어진 AI 코딩 에이전트",
  ...
  "temp.screenshot.caption": "tokyonight 테마가 적용된 cipher TUI",
  "temp.screenshot.alt": "tokyonight 테마가 적용된 cipher TUI",
  "temp.logoLightAlt": "cipher 밝은 로고",
  "temp.logoDarkAlt": "cipher 어두운 로고",
  ...
  "zen.title": "cipher Zen | 코딩 에이전트를 위한 신뢰할 수 있고 최적화된 모델 세트",
  ...
  "zen.faq.q1": "cipher Zen이란 무엇인가요?",
  "zen.faq.a1": "Zen은 cipher 팀이 코딩 에이전트를 위해 테스트하고 벤치마킹한 엄선된 AI 모델 세트입니다.",
  ...
  "zen.problem.subtitle": "우리는 cipher 사용자뿐만 아니라 모든 분들을 위해 이 문제를 해결하고 있습니다.",
  ...
  "go.title": "cipher Go | 모두를 위한 저비용 코딩 모델",
  "go.meta.description":
  ...
  "go.problem.body":
    "우리는 가능한 많은 사람들에게 cipher 경험을 제공하는 데 집중하고 있습니다. cipher Go는 저렴한 구독 서비스로, 첫 달 $5, 이후 $10/월입니다. 넉넉한 한도와 가장 뛰어난 오픈 소스 모델에 대한 안정적인 액세스를 제공합니다.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body": "Go는 첫 달 $5, 이후 $10/월로 시작합니다. cipher 또는 어떤 에이전트와도 함께 사용할 수 있습니다.",
  ...
  "zen.api.error.trialEnded":
    "{{model}}의 무료 프로모션이 종료되었습니다. cipher Go를 구독하면 모델을 계속 사용할 수 있습니다 - {{link}}",

  "black.meta.title": "cipher Black | 세계 최고의 코딩 모델에 액세스하세요",
  "black.meta.description": "cipher Black 구독 플랜으로 Claude, GPT, Gemini 등에 액세스하세요.",
  "black.hero.title": "세계 최고의 코딩 모델에 액세스하세요",
  "black.hero.subtitle": "Claude, GPT, Gemini 등 포함",
  "black.title": "cipher Black | 가격",
  ...
  "black.workspace.title": "cipher Black | 워크스페이스 선택",
  "black.workspace.selectPlan": "이 플랜을 사용할 워크스페이스를 선택하세요",
  "black.workspace.name": "워크스페이스 {{n}}",
  "black.subscribe.title": "cipher Black 구독하기",
  ...
  "black.subscribe.success.title": "cipher Black 대기 명단에 등록되었습니다",
  ...
  "workspace.newUser.step.login.after": "후 cipher 선택",
  ...
  "workspace.keys.subtitle": "cipher 서비스 액세스를 위한 API 키를 관리하세요.",
  "workspace.keys.create": "API 키 생성",
  "workspace.keys.placeholder": "키 이름 입력",
  "workspace.keys.empty": "cipher 게이트웨이 API 키 생성",
  ...
  "workspace.black.subscription.message": "현재 월 ${{plan}} cipher Black 플랜을 구독 중입니다.",
  ...
  "workspace.black.waitlist.joined": "월 ${{plan}} cipher Black 플랜 대기 명단에 등록되었습니다.",
  "workspace.black.waitlist.ready": "월 ${{plan}} cipher Black 플랜에 등록할 준비가 되었습니다.",
  ...
  "workspace.lite.subscription.message": "현재 cipher Go를 구독 중입니다.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Go 모델을 사용하려면 cipher 설정에서 "cipher Go"를 공급자로 선택하세요.',
  ...
  "workspace.lite.black.message":
    "현재 cipher Black을 구독 중이거나 대기 명단에 등록되어 있습니다. Go로 전환하려면 먼저 구독을 취소해 주세요.",
  "workspace.lite.other.message":
    "이 워크스페이스의 다른 멤버가 이미 cipher Go를 구독 중입니다. 워크스페이스당 한 명의 멤버만 구독할 수 있습니다.",
  "workspace.lite.promo.description":
    "cipher Go는 {{price}}부터 시작하며, 이후 $10/월로 넉넉한 사용량 한도와 함께 인기 있는 오픈 코딩 모델에 대한 안정적인 액세스를 제공합니다.",
  ...
  "download.title": "cipher | 다운로드",
  "download.meta.description": "macOS, Windows, Linux용 cipher 다운로드",
  "download.hero.title": "cipher 다운로드",
  "download.hero.subtitle": "macOS, Windows, Linux용 베타 버전 사용 가능",
  "download.hero.button": "{{os}}용 다운로드",
  "download.section.terminal": "cipher 터미널",
  "download.section.desktop": "cipher 데스크톱 (베타)",
  "download.section.extensions": "cipher 확장 프로그램",
  "download.section.integrations": "cipher 통합",
  ...
  "enterprise.title": "cipher | 조직을 위한 엔터프라이즈 솔루션",
  "enterprise.meta.description": "cipher 엔터프라이즈 솔루션 문의",
  ...
  "enterprise.faq.q1": "cipher 엔터프라이즈란 무엇인가요?",
  "enterprise.faq.a1":
    "cipher 엔터프라이즈는 코드와 데이터가 인프라 외부로 유출되지 않도록 보장하려는 조직을 위한 솔루션입니다. SSO 및 내부 AI 게이트웨이와 통합되는 중앙 집중식 설정을 통해 이를 구현합니다.",
  "enterprise.faq.q2": "cipher 엔터프라이즈는 어떻게 시작하나요?",
  "enterprise.faq.a2":
  ...
  "enterprise.faq.q4": "cipher 엔터프라이즈에서 데이터는 안전한가요?",
  "enterprise.faq.a4":
  ...
  "brand.title": "cipher | 브랜드",
  "brand.meta.description": "cipher 브랜드 가이드라인",
  "brand.heading": "브랜드 가이드라인",
  "brand.subtitle": "cipher 브랜드를 활용하는 데 도움이 되는 리소스와 자산입니다.",
  "brand.downloadAll": "모든 자산 다운로드",

  "changelog.title": "cipher | 변경 내역",
  "changelog.meta.description": "cipher 릴리스 노트 및 변경 내역",
