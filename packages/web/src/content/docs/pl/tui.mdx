---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala Cipher.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Cipher zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie Cipher uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI Cipher, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do Cipher. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij Cipher. _Aliasy_: `/quit`, `/q`
...
Jest to oddzielny plik od `cipher.json`, który konfiguruje zachowanie serwera/runtime.
...
- `leader_timeout` - Określa, jak długo Cipher czeka po naciśnięciu leader key. Domyślnie `2000`.
...
- `sound_pack` - ID sound pack do użycia. Domyślnie `Cipher.default`.
