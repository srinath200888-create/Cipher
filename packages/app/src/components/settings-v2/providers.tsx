...
import { Tag } from "@cipher-ai/ui/v2/badge-v2"
...
const PROVIDER_NOTES = [
  { match: (id: string) => id === "cipher", key: "dialog.provider.cipher.note" },
  { match: (id: string) => id === "cipher-go", key: "dialog.provider.cipherGo.tagline" },
...
export const SettingsProvidersV2: Component<{ onBack?: () => void }> = (props) => {
  ...
  const connected = createMemo(() => {
    return providers
      .connected()
      .filter((p) => p.id !== "cipher" || Object.values(p.models).find((m) => m.cost?.input))
  })
                  ...
                  <div class="settings-v2-provider-lead">
                    ...
                    <div class="settings-v2-provider-copy">
                      <div class="settings-v2-provider-main">
                        ...
                        <Show when={item.id === "cipher" || item.id === "cipher-go"}>
