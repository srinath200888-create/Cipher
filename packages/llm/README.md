...
Schema-first LLM core for Cipher. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@cipher-ai/llm"
import { OpenAI } from "@cipher-ai/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@cipher-ai/llm/providers"
