---
title: LSP serveri
description: Cipher se integriše sa vašim LSP serverima.
---

Cipher se može integrisati sa Language Server Protocol (LSP) serverima kako bi koristio dijagnostiku kao feedback za agenta.

## Ugrađeni

Cipher dolazi sa nekoliko ugrađenih LSP servera za popularne jezike:
...
:::note
Možete onemogućiti automatska preuzimanja LSP servera tako što ćete postaviti varijablu okruženja `CIPHER_DISABLE_LSP_DOWNLOAD` na `true`.
:::
...
Kada je LSP omogućen i Cipher otvori fajl, on:
...
Možete omogućiti i prilagoditi LSP servere kroz `lsp` odjeljak u vašoj Cipher konfiguraciji.
