...
export default function PrivacyPolicy() {
  ...
  return (
    <main data-page="legal">
      <Title>cipher | Privacy Policy</Title>
      <LocaleLinks path="/legal/privacy-policy" />
      <Meta name="description" content="cipher privacy policy" />
        ...
        <div data-component="content">
          <section data-component="brand-content">
            <article data-component="privacy-policy">
              ...
              <p>
                At cipher, we take your privacy seriously. Please read this Privacy Policy to learn how we treat your
                personal data.{" "}
                <strong>
              ...
              <p>
                Remember that your use of cipher is at all times subject to our Terms of Use,{" "}
              ...
              <p>
                ...
                time. We will alert you of material changes by placing a notice on the cipher website, by sending you
              ...
              <ul>
                <li>
                  ...
                  sending you information about cipher.
                </li>
              ...
              <p>
                ...
                you, cipher or another party; enforcing any agreements with you; responding to claims that any posting
