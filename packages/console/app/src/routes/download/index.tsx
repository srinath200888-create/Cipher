...
import desktopAppIcon from "../../asset/lander/cipher-desktop-icon.png"
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              ...
              >
                <code>
                  curl -fsSL https://<strong>cipher.ai/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g cipher-ai")}>
                <code>
                  npm i -g <strong>cipher-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g cipher-ai")}>
                <code>
                  bun add -g <strong>cipher-ai</strong>
                </code>
                <CopyStatus />
              </button>
              ...
              <button data-component="cli-row" onClick={handleCopyClick("paru -S cipher")}>
                <code>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask cipher-desktop")}>
                <code>
                  brew install --cask <strong>cipher-desktop</strong>
                </code>
                <CopyStatus />
              </button>
