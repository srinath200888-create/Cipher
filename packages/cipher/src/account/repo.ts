...
import { AccountStateTable, AccountTable } from "@cipher-ai/core/account/sql"
...
export class Service extends Context.Service<Service, Interface>()("@cipher/AccountRepo") {}
