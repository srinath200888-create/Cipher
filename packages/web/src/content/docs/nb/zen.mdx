---
title: Zen
description: Utvalgt liste over modeller levert av Cipher.
---
...
Cipher Zen er en liste over testede og verifiserte modeller levert av cipher-teamet.

Zen fungerer som enhver annen leverandør i Cipher. Du logger inn på Cipher Zen og får
...
:::tip
Vi testet en utvalgt gruppe modeller og leverandører som fungerer godt med Cipher.
:::
...
Cipher Zen er en AI gateway som gir deg tilgang til disse modellene.

---

## Slik fungerer det

Cipher Zen fungerer som enhver annen leverandør i Cipher.

1. Du logger inn på **<a href={console}>Cipher Zen</a>**, legger til
   faktureringsdetaljene dine og kopierer API-nøkkelen din.
2. Du kjører kommandoen `/connect` i TUI, velger Cipher Zen og limer inn API-nøkkelen din.
...
[modell-id](/docs/config/#models) i cipher-konfigurasjonen din
bruker formatet `opencode/<model-id>`. For eksempel, for GPT 5.5, ville du
brukt `cipher/gpt-5.5` i konfigurasjonen din.
...
- DeepSeek V4 Flash Free er tilgjengelig på Cipher i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- MiMo-V2.5 Free er tilgjengelig på Cipher i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- North Mini Code Free er tilgjengelig på Cipher i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Nemotron 3 Ultra Free er tilgjengelig på Cipher i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Big Pickle er en stealth-modell som er gratis på Cipher i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
...
4. Ha **ingen lock-in** ved å la deg bruke det med enhver annen kodeagent. Og alltid la deg bruke enhver annen leverandør med Cipher også.
