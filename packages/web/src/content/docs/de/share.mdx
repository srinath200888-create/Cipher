---
title: Teilen
description: Teile cipher-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu cipher-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht Cipher Folgendes:
...
Cipher hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt Cipher den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`cipher.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du Cipher in deiner Organisation einsetzt.
