---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez Cipher.
---
...
Cipher Zen to lista przetestowanych i zweryfikowanych modeli udostępniana przez zespół Cipher.

Zen działa jak każdy inny dostawca w Cipher. Logujesz się do Cipher Zen i otrzymujesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z Cipher.
:::
...
Cipher Zen to brama AI, która daje dostęp do tych modeli.

---

## Jak to działa

Cipher Zen działa jak każdy inny dostawca w Cipher.

1. Logujesz się do **<a href={console}>Cipher Zen</a>**, dodajesz dane
   rozliczeniowe i kopiujesz swój klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz Cipher Zen i wklejasz swój klucz API.
...
[ID modelu](/docs/config/#models) w Twojej konfiguracji Cipher używa formatu
...
- DeepSeek V4 Flash Free jest dostępny w Cipher przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- MiMo-V2.5 Free jest dostępny w Cipher przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- North Mini Code Free jest dostępny w Cipher przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Nemotron 3 Ultra Free jest dostępny w Cipher przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Big Pickle to stealth model, który jest darmowy w Cipher przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
...
4. Nie tworzyć **lock-in**, pozwalając używać tego z dowolnym innym agentem kodującym. I zawsze pozwalać Ci używać w Cipher także dowolnego innego dostawcy.
