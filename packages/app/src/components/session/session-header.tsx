import { AppIcon } from "@cipher-ai/ui/app-icon"
...
export function SessionHeader() {
  ...
  onMount(() => {
    setCenterMount(document.getElementById("cipher-titlebar-center"))
  })
