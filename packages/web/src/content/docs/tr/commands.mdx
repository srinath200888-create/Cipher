...
`.cipher/commands/test.md` oluştur:
...
Cipher işlemleri aracılığıyla veya `commands/` dizininde işaretleme dosyalarının oluşturulması özel komutlar ile yapılabilir.

---

### JSON

Cipher [config](/docs/config)'deki `command` seçeneğini kullanın:
...
Cipher, `/init`, `/undo`, `/redo`, `/share`, `/help` gibi çeşitli yerleşik komutlar içerir; [learn more](/docs/tui#commands).
