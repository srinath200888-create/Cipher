...
- Effect plugins import `@cipher-ai/plugin/v2/effect`, not `@cipher-ai/core`.
- Public domain values use generated `@cipher-ai/sdk` types.
...
- Define `PluginHost` domain capabilities in `@cipher-ai/plugin/v2/effect`.
