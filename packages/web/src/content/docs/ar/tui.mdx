---
title: TUI
description: استخدام واجهة المستخدم TUI في Cipher.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر Cipher واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل Cipher إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة Cipher في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى Cipher. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من Cipher. _الأسماء المستعارة_: `/quit`, `/q`
...
هذا منفصل عن `cipher.json`، الذي يضبط سلوك الخادم ووقت التشغيل.
...
- `leader_timeout` - يتحكم في مدة انتظار Cipher بعد الضغط على leader key. القيمة الافتراضية `2000`.
...
- `sound_pack` - sound pack ID المراد استخدامه. القيمة الافتراضية `Cipher.default`.
