...
export const dict = {
  ...
  "app.meta.description": "cipher - オープンソースのコーディングエージェント。",

  "home.title": "cipher | オープンソースのAIコーディングエージェント",

  "temp.title": "cipher | ターミナル向けに構築されたAIコーディングエージェント",
  ...
  "temp.screenshot.caption": "tokyonight テーマを使用した cipher TUI",
  "temp.screenshot.alt": "tokyonight テーマの cipher TUI",
  ...
  "zen.title": "cipher Zen | コーディングエージェント向けの信頼できる最適化モデル",
  "zen.hero.title": "コーディングエージェント向けの信頼できる最適化モデル",
  "zen.hero.body":
    "Zenは、OpenCodeがコーディングエージェント向けにテスト・ベンチマーク済みのAIモデルを厳選して提供します。プロバイダー間の性能・品質のブレを気にせず、検証済みのモデルを利用できます。",

  "zen.faq.q1": "cipher Zenとは？",
  "zen.faq.a1":
  ...
  "go.title": "cipher Go | すべての人のための低価格なコーディングモデル",
  "go.meta.description":
  ...
  "go.problem.body":
    "私たちはOpenCodeの体験をできるだけ多くの人に届けることに注力しています。cipher Goは低価格のサブスクリプションで、最初の月は$5、その後は$10/月です。ゆとりある上限と、最も高性能なオープンソースモデルへの信頼できるアクセスを提供します。",
  "go.problem.subtitle": " ",
  ...
  "zen.api.error.trialEnded":
    "{{model}} の無料プロモーションは終了しました。cipher Go を購読するとモデルを引き続き使用できます - {{link}}",

  "black.meta.title": "cipher Black | 世界最高峰のコーディングモデルすべてにアクセス",
  "black.meta.description": "cipher Black サブスクリプションプランで、Claude、GPT、Gemini などにアクセス。",
  "black.hero.title": "世界最高峰のコーディングモデルすべてにアクセス",
  "black.hero.subtitle": "Claude、GPT、Gemini などを含む",
  "black.title": "cipher Black | 料金",
  ...
  "black.workspace.title": "cipher Black | ワークスペースの選択",
  "black.workspace.selectPlan": "このプランのワークスペースを選択してください",
  "black.workspace.name": "ワークスペース {{n}}",
  "black.subscribe.title": "cipher Black を購読する",
  ...
  "black.subscribe.success.title": "cipher Black ウェイトリストに登録されました",
  ...
  "workspace.black.subscription.message": "あなたは cipher Black を月額 ${{plan}} で購読しています。",
  ...
  "workspace.black.waitlist.joined":
    "あなたは月額 ${{plan}} の cipher Black プランのウェイトリストに登録されています。",
  "workspace.black.waitlist.ready": "月額 ${{plan}} の cipher Black プランに登録する準備ができました。",
  ...
  "workspace.lite.subscription.message": "あなたは cipher Go を購読しています。",
  ...
  "workspace.lite.subscription.selectProvider":
    "Go モデルを使用するには、cipher の設定で「OpenCode Go」をプロバイダーとして選択してください。",
  ...
  "workspace.lite.black.message":
    "現在 cipher Black を購読中、またはウェイティングリストに登録されています。Go に切り替える場合は、先に登録を解除してください。",
  "workspace.lite.other.message":
    "このワークスペースの別のメンバーが既に cipher Go を購読しています。ワークスペースにつき1人のメンバーのみが購読できます。",
  "workspace.lite.promo.description":
    "cipher Goは{{price}}で始まり、その後は$10/月で、人気の高いオープンコーディングモデルへの安定したアクセスと余裕のある利用枠を提供します。",
  ...
  "download.title": "cipher | ダウンロード",
  "download.meta.description": "cipher を macOS、Windows、Linux 向けにダウンロード",
  "download.hero.title": "cipher をダウンロード",
  ...
  "enterprise.title": "cipher | 組織向けエンタープライズソリューション",
  ...
  "enterprise.faq.q1": "cipher Enterpriseとは？",
  "enterprise.faq.a1":
    "cipher Enterpriseは、コードとデータが決してインフラの外に出ないことを保証したい組織向けです。SSOや社内AIゲートウェイと統合する集中設定を使用することでこれを実現します。",
  "enterprise.faq.q2": "cipher Enterpriseを始めるには？",
  "enterprise.faq.a2":
