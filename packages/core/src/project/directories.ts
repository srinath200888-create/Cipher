...
import type { EffectDrizzleSqlite } from "@cipher-ai/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@cipher/ProjectDirectories") {}
