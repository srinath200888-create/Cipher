---
title: Share
description: Share your Cipher conversations.
---

cipher's share feature allows you to create public links to your Cipher conversations, so you can collaborate with teammates or get help from others.
...
When you share a conversation, Cipher:
...
Cipher supports three sharing modes that control how conversations are shared:

---

### Manual (default)

By default, Cipher uses manual sharing mode. Sessions are not shared automatically, but you can manually share them using the `/share` command:
...
To enforce this across your team for a given project, add it to the `cipher.json` in your project and check into Git.
...
[Learn more](/docs/enterprise) about using Cipher in your organization.
