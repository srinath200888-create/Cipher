export const dict = {
  ...
  "dialog.provider.cipher.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.cipher.tagline": "Modèles optimisés et fiables",
  "dialog.provider.cipherGo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par cipher",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans cipher.",
  ...
  "provider.connect.cipherZen.line1":
    "cipher Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.cipherZen.visit.prefix": "Visitez ",
  "provider.connect.cipherZen.visit.link": "cipher.ai/zen",
  "provider.connect.cipherZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans cipher.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans cipher.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans cipher.json",
  ...
  "dialog.server.description": "Changez le serveur cipher auquel cette application se connecte.",
  ...
  "toast.update.description":
    "Une nouvelle version d'cipher ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe cipher",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (cipher.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'cipher ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "cipher inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur cipher dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour cipher",
  "settings.general.row.appearance.title": "Apparence",
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'cipher sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si cipher suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'cipher.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'cipher",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'cipher.",
