...
Practical reference for the current tool-migration state in `packages/cipher`.
...
Tool tests should use the existing Effect helpers in `packages/cipher/test/lib/effect.ts`:
