---
title: Zen
description: Lista selecionada de modelos fornecidos pelo Cipher.
---
...
O Cipher Zen é uma lista de modelos testados e verificados fornecidos pela equipe do Cipher.

O Zen funciona como qualquer outro provedor no Cipher. Você faz login no Cipher Zen e recebe sua chave de API. É **completamente opcional** e você não precisa usá-lo para usar o Cipher.
...
:::tip
Testamos um grupo selecionado de modelos e provedores que funcionam bem com o Cipher.
:::
...
O Cipher Zen é um gateway de AI que dá a você acesso a esses modelos.

---

## Como funciona

O Cipher Zen funciona como qualquer outro provedor no Cipher.

1. Você faz login no **<a href={console}>Cipher Zen</a>**, adiciona seus dados de cobrança e copia sua chave de API.
2. Você executa o comando `/connect` no TUI, seleciona Cipher Zen e cola sua chave de API.
...
O [model id](/docs/config/#models) na sua configuração do Cipher usa o formato `opencode/<model-id>`. Por exemplo, para GPT 5.5, você usaria `cipher/gpt-5.5` na sua configuração.
...
- DeepSeek V4 Flash Free está disponível no Cipher por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- MiMo-V2.5 Free está disponível no Cipher por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- North Mini Code Free está disponível no Cipher por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Nemotron 3 Ultra Free está disponível no Cipher por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Big Pickle é um modelo stealth que está gratuito no Cipher por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
...
4. Não ter **lock-in**, permitindo que você o use com qualquer outro agente de codificação. E sempre permitir que você use qualquer outro provedor com o Cipher também.
