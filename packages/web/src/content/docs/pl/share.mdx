---
title: Udostępnianie
description: Udostępnij swoje rozmowy dotyczące Cipher.
---

Funkcja udostępniania Cipher umożliwia tworzenie publicznych linków do konwersacji Cipher, dzięki czemu możesz współpracować z członkami zespołu lub uzyskać pomoc od innych.
...
Kiedy udostępniasz rozmowę, Cipher:
...
Cipher obsługuje trzy tryby udostępniania, które kontrolują sposób udostępniania rozmów:

---

### Ręczne (domyślne)

Domyślnie Cipher korzysta z ręcznego trybu udostępniania. Sesje nie są udostępniane automatycznie, ale możesz je udostępnić ręcznie za pomocą polecenia `/share`:
...
Aby wymusić to w całym zespole dla danego projektu, dodaj go do `cipher.json` w swoim projekcie i sprawdź w Git.
...
[Dowiedz się więcej](/docs/enterprise) o używaniu Cipher w Twojej organizacji.
