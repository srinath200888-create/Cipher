...
import { ProjectDirectoryTable, ProjectTable } from "@cipher-ai/core/project/sql"
import { ProjectDirectories } from "@cipher-ai/core/project/directories"
...
import { which } from "@cipher-ai/core/util/which"
...
export class Service extends Context.Service<Service, Interface>()("@cipher/Project") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.CIPHER_FAKE_VCS)
