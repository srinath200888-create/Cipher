// Shared type vocabulary for the direct interactive mode (`cipher --mini`).
//
...
import type { OpencodeClient, PermissionRequest, QuestionRequest, ToolPart } from "@cipher-ai/sdk/v2"
