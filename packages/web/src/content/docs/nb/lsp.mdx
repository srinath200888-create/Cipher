---
title: LSP-servere
description: Cipher integreres med LSP-serverne dine.
---

Cipher kan integreres med Language Server Protocol (LSP)-servere for å bruke diagnostikk som tilbakemelding til agenten.

---

## Innebygde servere

Cipher kommer med flere innebygde LSP-servere for populære språk:
...
:::note
Du kan deaktivere automatiske LSP-servernedlastinger ved å sette miljøvariabelen `CIPHER_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktivert og Cipher åpner en fil, gjør den:
...
Du kan aktivere og tilpasse LSP-servere gjennom `lsp`-delen i cipher-konfigurasjonen.
