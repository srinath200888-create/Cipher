...
import { makeApi } from "@cipher-ai/protocol/api"
import { LocationMiddleware } from "@cipher-ai/server/location"
import { SessionLocationMiddleware } from "@cipher-ai/server/middleware/session-location"
...
export const RootHttpApi = HttpApi.make("cipher-root")
...
export const InstanceHttpApi = HttpApi.make("cipher-instance")
...
export const OpenCodeHttpApi = HttpApi.make("cipher")
