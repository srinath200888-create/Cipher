...
Opprett `.cipher/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom cipher-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i Cipher [config](/docs/config):
...
Cipher inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
