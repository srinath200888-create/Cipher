...
description: أنشئ أدوات يمكن لـ LLM استدعاؤها في Cipher.
---

الأدوات المخصصة هي دوال تنشئها يمكن لـ LLM استدعاؤها أثناء المحادثات. تعمل جنبا إلى جنب مع [الأدوات المدمجة](/docs/tools) في Cipher مثل `read` و`write` و`bash`.
...
- محليا بوضعها في مجلد `.cipher/tools/` داخل مشروعك.
