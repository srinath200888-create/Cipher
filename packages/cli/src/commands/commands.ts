...
declare const CIPHER_CLI_NAME: string | undefined

export const Commands = Spec.make(typeof CIPHER_CLI_NAME === "string" ? CIPHER_CLI_NAME : "cipher", {
  description: "cipher 2.0 preview command line interface",
  commands: [
    Spec.make("api", {
