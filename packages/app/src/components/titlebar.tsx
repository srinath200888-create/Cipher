...
import { Tooltip, TooltipKeybind } from "@cipher-ai/ui/tooltip"
import { useTheme } from "@cipher-ai/ui/theme/context"
import { IconButtonV2 } from "@cipher-ai/ui/v2/icon-button-v2"
import { Icon as IconV2 } from "@cipher-ai/ui/v2/icon"
import { KeybindV2 } from "@cipher-ai/ui/v2/keybind-v2"
...
export function useTitlebarRightMount() {
  ...
  onMount(() => setMount(document.getElementById("cipher-titlebar-right")))
  return mount
}
        ...
        <Match when>
          ...
          >
              ...
              <div class="flex items-center gap-1 shrink-0">
                ...
                <div class="hidden xl:flex items-center shrink-0">
                  ...
                  >
                    ...
                    <div id="cipher-titlebar-left" class="flex items-center gap-3 min-w-0 px-2" />
                    <ChannelIndicator />
                  </div>
                </div>
              </div>
            ...
            <div
              ...
              onMouseDown={drag}
            >
              <div id="cipher-titlebar-right" class="flex items-center gap-1 shrink-0 justify-end" />
              <Show when={windows()}>
...
function TitlebarV2Right(props: { state: TitlebarV2RightState }) {
  return (
    <div class="relative z-20 flex shrink-0 items-center justify-end gap-0 overflow-visible">
      ...
      <div id="cipher-titlebar-right" class="flex shrink-0 items-center justify-end gap-0" />
    </div>
  )
}
...
function ChannelIndicator() {
  return (
    <>
      {["beta", "dev"].includes(import.meta.env.VITE_CIPHER_CHANNEL) && (
        <div class="bg-icon-interactive-base text-[#FFF] font-medium px-2 rounded-sm uppercase font-mono">
          {import.meta.env.VITE_CIPHER_CHANNEL.toUpperCase()}
        </div>
      )}
    </>
  )
