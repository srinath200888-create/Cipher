---
title: Zen
description: Lista curata di modelli fornita da Cipher.
---
...
Cipher Zen è un elenco di modelli testati e verificati forniti dal team di Cipher.

Zen funziona come qualsiasi altro provider in Cipher. Accedi a Cipher Zen e ottieni
...
:::tip
Abbiamo testato un gruppo selezionato di modelli e provider che funzionano bene con Cipher.
:::
...
Cipher Zen è un gateway AI che ti dà accesso a questi modelli.

---

## Come funziona

Cipher Zen funziona come qualsiasi altro provider in Cipher.

1. Accedi a **<a href={console}>Cipher Zen</a>**, aggiungi i dettagli di fatturazione,
   e copia la tua chiave API.
2. Esegui il comando `/connect` nella TUI, seleziona Cipher Zen, e incolla la tua chiave API.
...
Il [model id](/docs/config/#models) nella config di Cipher
usa il formato `opencode/<model-id>`. Per esempio, per GPT 5.5, useresti
`cipher/gpt-5.5` nella tua config.
...
- DeepSeek V4 Flash Free è disponibile su Cipher per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- MiMo-V2.5 Free è disponibile su Cipher per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- North Mini Code Free è disponibile su Cipher per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Nemotron 3 Ultra Free è disponibile su Cipher per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Big Pickle è un modello stealth che è gratuito su Cipher per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
...
4. Non avere **lock-in** permettendoti di usarlo con qualsiasi altro agente di coding. E permettendoti sempre di usare anche qualsiasi altro provider con Cipher.
