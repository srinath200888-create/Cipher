...
مع Cipher يمكنك الاختيار من بين عدة سمات مدمجة، أو استخدام سمة تتكيّف مع سمة terminal لديك، أو تعريف سمة مخصصة خاصة بك.

افتراضيًا، يستخدم Cipher سمتنا `Cipher`.
...
- يريدون أن يطابق Cipher مظهر terminal لديهم
...
يدعم Cipher نظام سمات مرنًا قائمًا على JSON يتيح للمستخدمين إنشاء السمات وتخصيصها بسهولة.
...
3. **مجلد جذر المشروع** - معرّف في `<project-root>/.cipher/themes/*.json`
4. **مجلد العمل الحالي** - معرّف في `./.cipher/themes/*.json`
