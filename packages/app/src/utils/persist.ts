...
const GLOBAL_STORAGE = "cipher.global.dat"
const WINDOW_STORAGE = "cipher.window"
const LOCAL_PREFIX = "cipher."
...
function workspaceStorage(dir: string) {
  ...
  return `cipher.workspace.${head}.${sum}.dat`
}
...
function draftStorage(draftID: string) {
  ...
  return `cipher.draft.${head}.${sum}.dat`
}
