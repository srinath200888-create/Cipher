...
import compareVideo from "../../asset/lander/cipher-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/cipher-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="cipher:auth" content={loggedin() ? "true" : "false"} />
