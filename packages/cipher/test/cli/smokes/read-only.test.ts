...
describe("opencode read-only commands (smoke)", () => {
  ...
  // CIPHER_CONFIG_CONTENT={} we provide, no servers should be configured
  ...
  // `session list` reads the session DB. Fresh CIPHER_TEST_HOME means
  ...
  // in production it'd be a path under CIPHER_TEST_HOME / XDG_DATA_HOME.
