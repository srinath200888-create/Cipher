---
title: TUI
description: Bruke cipher-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Cipher gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre Cipher starter TUI for gjeldende katalog.
...
Når du bruker Cipher TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til Cipher. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt Cipher. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `cipher.json`, som konfigurerer server-/kjøretidsoppførsel.
...
- `leader_timeout` - Styrer hvor lenge Cipher venter etter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID som skal brukes. Standard er `Cipher.default`.
