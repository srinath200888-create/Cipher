...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders CIPHER_CALLER", () => {
    process.env["CIPHER_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode CIPHER_CALLER", () => {
    process.env["CIPHER_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown CIPHER_CALLER", () => {
    process.env["CIPHER_CALLER"] = "unknown"
