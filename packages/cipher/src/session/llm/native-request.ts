import type { JsonSchema, LLMRequest, ProviderMetadata } from "@cipher-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@cipher-ai/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @cipher-ai/llm request objects from cipher's session/AI SDK-shaped data.
  return LLM.request({
