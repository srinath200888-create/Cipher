...
Con Cipher puede seleccionar uno de varios temas integrados, usar un tema que se adapte al tema de su terminal o definir su propio tema personalizado.

De forma predeterminada, Cipher usa nuestro propio tema `Cipher`.
...
Cipher viene con varios temas integrados.
...
- Quiere que Cipher coincida con la apariencia de su terminal
...
Cipher admite un sistema de temas flexible basado en JSON que permite a los usuarios crear y personalizar temas fácilmente.
...
3. **Directorio raíz del proyecto**: definido en `<project-root>/.cipher/themes/*.json`
4. **Directorio de trabajo actual** - Definido en `./.cipher/themes/*.json`
