...
description: Opret værktøjer, som LLM kan kalde Cipher ind.
---

Brugerdefinerede værktøjer er funktioner, du opretter, som LLM kan kalde under samtaler. De arbejder sammen med ciphers [built-in tools](/docs/tools) som `read`, `write` og `bash`.
...
- Lokalt ved at placere dem i biblioteket `.cipher/tools/` i dit projekt.
