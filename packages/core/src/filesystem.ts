...
import { Entry, FileSystem, FindInput, Match } from "@cipher-ai/schema/filesystem"
export { Entry, Match, Submatch } from "@cipher-ai/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@cipher/v2/FileSystem") {}
