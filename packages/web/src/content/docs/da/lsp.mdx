---
title: LSP-servere
description: Cipher integreres med dine LSP-servere.
---

Cipher kan integreres med Language Server Protocol (LSP)-servere for at bruge diagnostik som feedback til agenten.

---

## Indbyggede

Cipher leveres med flere indbyggede LSP-servere til populære sprog:
...
:::note
Du kan deaktivere automatisk LSP-serverdownloads ved at indstille miljøvariablen `CIPHER_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktiveret, og Cipher åbner en fil, vil den:
...
Du kan aktivere og tilpasse LSP-servere gennem sektionen `lsp` i din cipher-konfiguration.
