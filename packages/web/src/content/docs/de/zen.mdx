---
title: Zen
description: Kuratierte Modellliste direkt von Cipher.
---
...
Cipher Zen ist eine Liste von getesteten und verifizierten Modellen, die vom cipher-Team bereitgestellt wird.

Zen funktioniert wie jeder andere Provider in Cipher. Du meldest dich bei Cipher Zen an und erhältst deinen API-Key. Es ist **vollständig optional** und du musst es nicht verwenden, um Cipher zu nutzen.
...
:::tip
Wir haben eine ausgewählte Gruppe von Modellen und Providern getestet, die gut mit Cipher funktionieren.
:::
...
Cipher Zen ist ein AI-Gateway, das dir Zugriff auf diese Modelle gibt.

---

## So funktioniert es

Cipher Zen funktioniert wie jeder andere Provider in Cipher.

1. Du meldest dich bei **<a href={console}>Cipher Zen</a>** an, hinterlegst deine Zahlungsdaten und kopierst deinen API-Key.
2. Du führst den Befehl `/connect` in der TUI aus, wählst Cipher Zen aus und fügst deinen API-Key ein.
...
Die [Model-ID](/docs/config/#models) in deiner cipher-Konfiguration verwendet das Format `opencode/<model-id>`. Für GPT 5.5 würdest du zum Beispiel `cipher/gpt-5.5` in deiner Konfiguration verwenden.
...
- DeepSeek V4 Flash Free ist für begrenzte Zeit auf Cipher verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- MiMo-V2.5 Free ist für begrenzte Zeit auf Cipher verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- North Mini Code Free ist für begrenzte Zeit auf Cipher verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Nemotron 3 Ultra Free ist für begrenzte Zeit auf Cipher verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Big Pickle ist ein Stealth-Modell, das für begrenzte Zeit kostenlos auf Cipher verfügbar ist. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
...
Wir haben Cipher Zen geschaffen, um:
...
4. **keinen Lock-in** zu haben, indem du es mit jedem anderen Coding-Agenten verwenden kannst. Und dir außerdem immer zu erlauben, mit Cipher auch jeden anderen Provider zu verwenden.
