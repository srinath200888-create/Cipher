...
import { path } from "@cipher-ai/core/effect/app-node-platform"
...
import type { ProjectV2 } from "@cipher-ai/core/project"
...
import { WorktreeEvent } from "@cipher-ai/schema/worktree-event"
...
export class Service extends Context.Service<Service, Interface>()("@cipher/Worktree") {}
