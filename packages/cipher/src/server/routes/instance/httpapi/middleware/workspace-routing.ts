...
>()("@cipher/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@cipher/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.CIPHER_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.CIPHER_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-cipher-directory"] || process.cwd()
}
