...
import video from "../asset/lander/cipher-min.mp4"
import videoPoster from "../asset/lander/cipher-poster.png"
                  ...
                  <Tabs.Content as="pre" data-slot="panel" value="curl">
                    <button data-copy data-slot="command" onClick={handleCopyClick}>
                      <span data-slot="command-script">
                        ...
                        <span data-slot="highlight">cipher.ai/install</span>
                        <span> | bash</span>
                      </span>
                      <CopyStatus />
                    </button>
                  ...
                  <Tabs.Content as="pre" data-slot="panel" value="npm">
                    <button data-copy data-slot="command" onClick={handleCopyClick}>
                      <span>
                        ...
                        <span data-slot="highlight">cipher-ai</span>
                      </span>
                      <CopyStatus />
                    </button>
                  </Tabs.Content>
