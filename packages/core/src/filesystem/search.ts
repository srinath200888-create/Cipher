...
export class Service extends Context.Service<Service, Interface>()("@cipher/v2/FileSystem/Search") {}
...
const layer = Layer.unwrap(Effect.sync(() => (Flag.CIPHER_DISABLE_FFF || !Fff.available() ? ripgrepLayer : fffLayer)))
