...
Puede agregar comandos personalizados a través de la configuración Cipher o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su Cipher [config](/docs/config):
...
Cipher incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
