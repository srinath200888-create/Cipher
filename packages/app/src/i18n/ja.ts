export const dict = {
  ...
  "dialog.provider.cipher.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  "dialog.provider.cipher.tagline": "信頼性の高い最適化モデル",
  "dialog.provider.cipherGo.tagline": "すべての人に低価格のサブスクリプション",
  ...
  "provider.connect.cipherZen.line1":
    "cipher Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  "provider.connect.cipherZen.line2": "1つのAPIキーで、Claude、GPT、Gemini、GLMなどのモデルにアクセスできます。",
  "provider.connect.cipherZen.visit.prefix": " ",
  "provider.connect.cipherZen.visit.link": "cipher.ai/zen",
  "provider.connect.cipherZen.visit.suffix": " にアクセスしてAPIキーを取得してください。",
  ...
  "dialog.plugins.empty": "cipher.jsonで設定されたプラグイン",
  ...
  "error.chain.checkConfig": "config (cipher.json) のプロバイダー/モデル名を確認してください",
  ...
  "settings.updates.row.startup.description": "cipher の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "cipher は最新バージョンです。",
