...
import type { MessageV2 } from "cipher/session/message-v2"
import type { Message } from "cipher/session/message"
import type { Session } from "cipher/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.CIPHER_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.CIPHER_name}>
