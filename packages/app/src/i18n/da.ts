export const dict = {
  ...
  "dialog.provider.cipher.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.cipher.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.cipherGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af cipher",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i cipher.",
  ...
  "provider.connect.cipherZen.line1":
    "cipher Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.cipherZen.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.cipherZen.visit.prefix": "Besøg ",
  "provider.connect.cipherZen.visit.link": "cipher.ai/zen",
  "provider.connect.cipherZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i cipher.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i cipher.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i cipher.json",
  ...
  "dialog.server.description": "Skift hvilken cipher-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af cipher ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til cipher-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (cipher.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, cipher understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "cipher inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør cipher-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for cipher",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan cipher ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om cipher følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan cipher er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når cipher starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af cipher.",
