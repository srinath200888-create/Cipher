import type { Hooks, PluginInput } from "@cipher-ai/plugin"
import type { Model } from "@cipher-ai/sdk/v2"
import { InstallationVersion } from "@cipher-ai/core/installation/version"
import { OauthCallbackPage } from "@cipher-ai/core/oauth/page"
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              url,
              instructions:
                "Sign in to DigitalOcean in your browser. cipher will use your DigitalOcean API token directly for inference and load your Inference Routers. Re-run /connect to refresh routers later.",
