...
import { Event } from "@cipher-ai/schema/project-directories"
import { ProjectCopy } from "@cipher-ai/schema/project-copy"
...
export class Service extends Context.Service<Service, Interface>()("@cipher/ProjectCopy") {}
