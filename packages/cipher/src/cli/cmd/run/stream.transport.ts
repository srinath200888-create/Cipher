...
import type { Event, GlobalEvent, OpencodeClient } from "@cipher-ai/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@cipher/RunStreamTransport") {}
