...
import type { Data, Definition, Payload } from "@cipher-ai/schema/event"
...
import { Durable } from "@cipher-ai/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@cipher-ai/schema/event").ID
export type { Data, Definition, Payload } from "@cipher-ai/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@cipher/Event") {}
