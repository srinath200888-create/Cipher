export const dict = {
  ...
  "dialog.provider.cipher.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.cipher.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.cipherGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo cipher",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no cipher.",
  ...
  "provider.connect.cipherZen.line1":
    "cipher Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  "provider.connect.cipherZen.line2":
    "Com uma única chave de API você terá acesso a modelos como Claude, GPT, Gemini, GLM e mais.",
  "provider.connect.cipherZen.visit.prefix": "Visite ",
  "provider.connect.cipherZen.visit.link": "cipher.ai/zen",
  "provider.connect.cipherZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no cipher.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no cipher.",
  ...
  "dialog.plugins.empty": "Plugins configurados em cipher.json",
  ...
  "dialog.server.description": "Trocar para qual servidor cipher este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do cipher ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do cipher",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (cipher.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: cipher ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "cipher inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor cipher dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do cipher",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o cipher aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o cipher segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o cipher é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o cipher iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do cipher.",
