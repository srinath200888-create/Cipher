...
const SIDECAR_SERVICE_NAME = "cipher server"
...
export function preferAppEnv(userDataPath: string) {
  ...
  Object.assign(process.env, {
    ...
    CIPHER_EXPERIMENTAL_ICON_DISCOVERY: "true",
    CIPHER_EXPERIMENTAL_FILEWATCHER: "true",
...
function createSidecarEnv(): Record<string, string> {
  ...
  if (!app.isPackaged) env.CIPHER_DISABLE_CHANNEL_DB = "1"
  return env
}
