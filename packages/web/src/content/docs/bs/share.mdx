---
title: Dijeljenje
description: Dijelite Cipher razgovore javnim linkovima.
---

Cipher opcija dijeljenja vam omogucava da kreirate javne linkove za razgovore. Tako lakse saradujete s timom ili trazite pomoc od drugih.
...
Kada podijelite razgovor, Cipher:
...
Cipher podrzava tri nacina dijeljenja koji odreduju kako se razgovori dijele:

---

### Ručno (zadano)

Po defaultu, Cipher koristi rucni nacin dijeljenja. Sesije se ne dijele automatski, ali ih mozete rucno podijeliti komandom `/share`:
...
Da ovo vazi za cijeli tim u odredenom projektu, dodajte postavku u projektni `cipher.json` i commitujte u Git.
...
[Saznajte vise](/docs/enterprise) o koristenju Cipher u organizaciji.
