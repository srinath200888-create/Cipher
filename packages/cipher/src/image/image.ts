...
export class Service extends Context.Service<Service, Interface>()("@cipher/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __CIPHER_PHOTON_WASM_PATH?: string }).__CIPHER_PHOTON_WASM_PATH =
