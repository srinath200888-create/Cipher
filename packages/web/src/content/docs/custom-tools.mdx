---
title: Custom Tools
description: Create tools the LLM can call in Cipher.
---

Custom tools are functions you create that the LLM can call during conversations. They work alongside cipher's [built-in tools](/docs/tools) like `read`, `write`, and `bash`.
...
- Locally by placing them in the `.cipher/tools/` directory of your project.
