---
title: Zen
description: Curated list of models provided by Cipher.
---
...
Cipher Zen is a list of tested and verified models provided by the Cipher team.

Zen works like any other provider in Cipher. You login to Cipher Zen and get
...
:::tip
We tested a select group of models and providers that work well with Cipher.
:::
...
Cipher Zen is an AI gateway that gives you access to these models.

---

## How it works

Cipher Zen works like any other provider in Cipher.

1. You sign in to **<a href={console}>Cipher Zen</a>**, add your billing
   details, and copy your API key.
2. You run the `/connect` command in the TUI, select Cipher Zen, and paste your API key.
...
The [model id](/docs/config/#models) in your Cipher config
uses the format `opencode/<model-id>`. For example, for GPT 5.5, you would
use `cipher/gpt-5.5` in your config.
...
- DeepSeek V4 Flash Free is available on Cipher for a limited time. The team is using this time to collect feedback and improve the model.
- MiMo-V2.5 Free is available on Cipher for a limited time. The team is using this time to collect feedback and improve the model.
- North Mini Code Free is available on Cipher for a limited time. The team is using this time to collect feedback and improve the model.
- Nemotron 3 Ultra Free is available on Cipher for a limited time. The team is using this time to collect feedback and improve the model.
- Big Pickle is a stealth model that's free on Cipher for a limited time. The team is using this time to collect feedback and improve the model.
...
4. Have **no lock-in** by allowing you to use it with any other coding agent. And always let you use any other provider with Cipher as well.
