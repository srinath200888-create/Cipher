export const dict = {
  ...
  "dialog.provider.cipher.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.cipher.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.cipherGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje cipher",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u cipher-u.",
  ...
  "provider.connect.cipherZen.line1":
    "cipher Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  "provider.connect.cipherZen.line2":
    "Sa jednim API ključem dobijaš pristup modelima kao što su Claude, GPT, Gemini, GLM i drugi.",
  "provider.connect.cipherZen.visit.prefix": "Posjeti ",
  "provider.connect.cipherZen.visit.link": "cipher.ai/zen",
  "provider.connect.cipherZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u cipher-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u cipher-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u cipher.json",
  ...
  "dialog.server.description": "Promijeni na koji se cipher server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija cipher-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku cipher timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (cipher.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: cipher još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "cipher uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni cipher server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u cipher-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako cipher izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li cipher prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu cipher-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se cipher pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju cipher-a.",
