...
Kreiraj `.cipher/commands/test.md`:
...
Možete dodati prilagođene komande kroz Cipher konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom Cipher [config](/docs/config):
...
Cipher uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
